...
import com.psliusar.nicolas.utils.ImageUtils
...
class TextAnalyzer(
    ...
    override fun analyze(imageProxy: ImageProxy) {
        ...
        if (actualAspectRatio > 3) {
            ...
            imageCropPercentages.value =
                originalHeightCropPercentage / 2 to originalWidthCropPercentage
        }
    ...
    private fun getErrorMessage(exception: Exception): String? {
        return if (exception is MlKitException && exception.errorCode == MlKitException.UNAVAILABLE) {
